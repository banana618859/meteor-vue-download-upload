  ...
  <div>
    ...
    <div>
        <el-dialog
            ...
            <p><el-input v-model="username" placeholder="user"></el-input></p>
            <p><el-input v-model="password" placeholder="pawd"></el-input></p>
  ...
  methods: {
    ...
    ddpConnect(){
      ...
      return new Promise((resolve,reject) => {
        ...
        var conn = DDP.connect(remote_url,{retry: false});
        var count = 0;
        Tracker.autorun(() => {
